// Fails the build when an HTML page references an asset that Vite did not emit.
// Vite silently leaves non-module <script src="..."> tags untouched, so such files
// must live in public/ or they 404 in production.
